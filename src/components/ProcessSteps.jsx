...
const ProcessSteps = () => {
  ...
  return (
    <div className="relative w-full flex flex-col items-center bg-gray-100 py-16">
      ...
      {/* SVG Progress Curve */}
      <svg className="absolute w-3/4 top-20" viewBox="0 0 800 200" fill="none" stroke="#6366F1" strokeWidth="3">
        <path className="process-line" d="M0 150 Q200 250, 400 100 T800 50" strokeLinecap="round" fill="none" />
      </svg>
