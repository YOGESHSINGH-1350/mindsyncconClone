    ...
    <div className="bg-white py-20">
      <div className="container mx-auto flex flex-col lg:flex-row items-center px-6 lg:px-20">
        ...
        <h2 className="text-6xl font-bold text-gray-900 relative inline-block mb-5"> 
          <span className="absolute  top-4 left-50 transform -translate-x-1/2 text-[#684DF4] text-lg tracking-wide font-semibold">
            Why Choose Us
          </span>
          ...
          <p className="mt-4 text-lg text-gray-800">
            Providing comprehensive solutions in software development, IT consulting,
            system integration, and managed services to enhance business efficiency and growth.
          </p>
        ...
        <div className="lg:w-1/2 flex justify-center mt-10 lg:mt-0">
          <Image
            ...
            width={500}
            height={500}
            className="w-[450px] h-auto object-cover rounded-lg shadow-lg bg-[#141D38]"
          />
        </div>
      </div>
    </div>
